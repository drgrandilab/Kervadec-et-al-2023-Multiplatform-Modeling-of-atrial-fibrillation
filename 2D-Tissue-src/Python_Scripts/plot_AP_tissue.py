...
folder = 'Bin_kmf.0.25.ISO.1.0.test/'
Cai = []
Cai2 = []
ID1=5
ID2 =5000+350
for i in range( 3994,5000+10000,1):
...
outdata = np.column_stack([data, data2])

# outdata = np.array(([]).append(data).append(data2))
# outdata.tofile('out.dat',sep=' ', format='%f')
np.savetxt('out.dat', outdata, fmt='%f')
